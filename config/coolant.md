...
<!-- config-item path="coolant.mist_pin" -->
### mist_pin
- **Type:** [Pin](/config/overview#pin) (output)
- **Range:** gpio or i2so
- **Default:** `NO_PIN`

This is used to control a mist coolant device. M7 turns mist coolant on and M9 turns it off.
<!-- /config-item -->

<!-- config-item path="coolant.flood_pin" -->
### flood_pin
- **Type:** [Pin](/config/overview#pin) (output)
- **Range:** gpio or i2so
- **Default:** `NO_PIN`

This is used to control a flood coolant device. M8 turns flood coolant on and M9 turns it off.
<!-- /config-item -->

<!-- config-item path="coolant.delay_ms" -->
### delay_ms
- **Type:** [Integer](/config/overview#integer)
- **Range:** 0 to 10000
- **Default:** `0`

The delay in milliseconds after the turn on of M7 and M8. It will not delay if that coolant is already on. It does not delay with M9.
<!-- /config-item -->
